...
public class HeroCard {
     ...
     * @return the HeroCard object itself.
     */
    public HeroCard withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return the HeroCard object itself.
     */
    public HeroCard withSubtitle(String subtitle) {
     ...
     * @return the HeroCard object itself.
     */
    public HeroCard withText(String text) {
        this.text = text;
        return this;
    }
     ...
     * @return the HeroCard object itself.
     */
    public HeroCard withImages(List<CardImage> images) {
        this.images = images;
        return this;
    }
     ...
     * @return the HeroCard object itself.
     */
    public HeroCard withButtons(List<CardAction> buttons) {
     ...
     * @return the HeroCard object itself.
     */
    public HeroCard withTap(CardAction tap) {
        this.tap = tap;
        return this;
    }
