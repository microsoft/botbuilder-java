...
public class ActivityTest {
    ...
    @Test
    public void AsContactRelationUpdateActivity() {
        Activity activity = createActivity();

        activity.setType("contactRelationUpdate");

        Activity result = activity.asContactRelationUpdateActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.CONTACT_RELATION_UPDATE);
    }

    @Test
    public void AsContactRelationUpdateActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsInstallationUpdateActivity() {
        Activity activity = createActivity();

        activity.setType("installationUpdate");

        Activity result = activity.asInstallationUpdateActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.INSTALLATION_UPDATE);
    }

    @Test
    public void AsInstallationUpdateActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsConversationUpdateActivity() {
        Activity activity = createActivity();

        activity.setType("conversationUpdate");

        Activity result = activity.asConversationUpdateActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.CONVERSATION_UPDATE);
    }

    @Test
    public void AsConversationUpdateActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsTypingActivity() {
        Activity activity = createActivity();

        activity.setType("typing");

        Activity result = activity.asTypingActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.TYPING);
    }

    @Test
    public void AsTypingActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsEndOfConversationActivity() {
        Activity activity = createActivity();

        activity.setType("endOfConversation");

        Activity result = activity.asEndOfConversationActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.END_OF_CONVERSATION);
    }

    @Test
    public void AsEndOfConversationActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsEventActivity() {
        Activity activity = createActivity();

        activity.setType("event");

        Activity result = activity.asEventActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.EVENT);
    }

    @Test
    public void AsEventActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsInvokeActivity() {
        Activity activity = createActivity();

        activity.setType("invoke");

        Activity result = activity.asInvokeActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.INVOKE);
    }

    @Test
    public void AsInvokeActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsMessageUpdateActivity() {
        Activity activity = createActivity();

        activity.setType("messageUpdate");

        Activity result = activity.asMessageUpdateActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.MESSAGE_UPDATE);
    }

    @Test
    public void AsMessageUpdateActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsMessageDeleteActivity() {
        Activity activity = createActivity();

        activity.setType("messageDelete");

        Activity result = activity.asMessageDeleteActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.MESSAGE_DELETE);
    }

    @Test
    public void AsMessageDeleteActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsMessageReactionActivity() {
        Activity activity = createActivity();

        activity.setType("messageReaction");

        Activity result = activity.asMessageReactionActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.MESSAGE_REACTION);
    }

    @Test
    public void AsMessageReactionActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsSuggestionActivity() {
        Activity activity = createActivity();

        activity.setType("suggestion");

        Activity result = activity.asSuggestionActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.SUGGESTION);
    }

    @Test
    public void AsSuggestionActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsTraceActivity() {
        Activity activity = createActivity();

        activity.setType("trace");

        Activity result = activity.asTraceActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.TRACE);
    }

    @Test
    public void AsTraceActivityIsNull() {
        Activity activity = createActivity();
    ...
    @Test
    public void AsHandoffActivity() {
        Activity activity = createActivity();

        activity.setType("handoff");

        Activity result = activity.asHandoffActivity();

        Assert.assertEquals(result.getType(), ActivityTypes.HANDOFF);
    }
