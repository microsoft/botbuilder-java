 ...
 * controller should do so by using the @Import({BotCloudAdapterController.class})
 * annotation. See any of the samples Application class for an example.
 * </p>
 */
@RestController
public class BotCloudAdapterController {
    /**
    ...
    /**
     * The CloudAdapter to use. Note is is provided by dependency
     ...
     *
     * @param withAdapter The CloudAdapter to use.
     * @param withBot     The Bot to use.
     */
    public BotCloudAdapterController(CloudAdapter withAdapter, Bot withBot) {
        adapter = withAdapter;
        bot = withBot;
    }
