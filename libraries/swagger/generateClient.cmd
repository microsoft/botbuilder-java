...
call .\node_modules\.bin\replace "import com.microsoft.rest.RestException;" "import com.microsoft.rest.RestException;import com.microsoft.bot.schema.ErrorResponse;" . -r -q --include="ErrorResponseException.java"
