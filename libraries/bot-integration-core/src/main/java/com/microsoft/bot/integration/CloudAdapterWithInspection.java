...
/**
 * A CloudAdapter that use InspectionMiddleware to forward message
 ...
 * </p>
 */
public class CloudAdapterWithInspection extends CloudAdapterWithErrorHandler {
    /**
     ...
     */
    public CloudAdapterWithInspection(
