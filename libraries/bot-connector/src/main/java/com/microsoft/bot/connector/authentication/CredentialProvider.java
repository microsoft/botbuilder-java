...
/**
 * CredentialProvider interface. This interface allows Bots to provide their own implementation of what is,
 * and what is not, a valid appId and password. This is useful in the case of multi-tenant bots, where the
 * bot may need to call out to a service to determine if a particular appid/password pair is valid.
 *
...
public interface CredentialProvider {
     ...
     * @return A task that represents the work queued to execute. If the task is successful and the app ID is valid,
