 ...
 */
public class ConversationResourceResponseInner {
    /**
     ...
     * @return the ConversationResourceResponseInner object itself.
     */
    public ConversationResourceResponseInner withActivityId(String activityId) {
     ...
     * @return the ConversationResourceResponseInner object itself.
     */
    public ConversationResourceResponseInner withServiceUrl(String serviceUrl) {
     ...
     * @return the ConversationResourceResponseInner object itself.
     */
    public ConversationResourceResponseInner withId(String id) {
        this.id = id;
        return this;
    }
