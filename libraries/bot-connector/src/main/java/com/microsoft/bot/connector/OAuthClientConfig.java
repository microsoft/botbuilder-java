...
public final class OAuthClientConfig {
    ...
    /**
     * Value indicating whether when using the Emulator, whether to emulate the OAuthCard behavior or use
     * connected flows.
     */
     ...
     */
    public static CompletableFuture<Void> sendEmulateOAuthCards(OAuthClient client, boolean emulate) {
