...
import com.microsoft.bot.connector.ConversationAccount;
import com.microsoft.bot.connector.TextFormatTypes;
import com.microsoft.bot.connector.AttachmentLayoutTypes;
import java.util.List;
import com.microsoft.bot.connector.MessageReaction;
import com.microsoft.bot.connector.InputHints;
import com.microsoft.bot.connector.SuggestedActions;
import com.microsoft.bot.connector.Attachment;
import com.microsoft.bot.connector.Entity;
import com.microsoft.bot.connector.ConversationReference;
import com.microsoft.bot.connector.EndOfConversationCodes;
import com.microsoft.bot.connector.TextHighlight;
...
public class ActivityInner {
     ...
     */
    public ActivityInner withType(ActivityTypes type) {
        this.type = type;
        return this;
    }
     ...
     * @return the ActivityInner object itself.
     */
    public ActivityInner withTextFormat(TextFormatTypes textFormat) {
     ...
     * @return the ActivityInner object itself.
     */
    public ActivityInner withAttachmentLayout(AttachmentLayoutTypes attachmentLayout) {
     ...
     * @return the ActivityInner object itself.
     */
    public ActivityInner withInputHint(InputHints inputHint) {
     ...
     * @return the ActivityInner object itself.
     */
    public ActivityInner withCode(EndOfConversationCodes code) {
        this.code = code;
        return this;
    }
     ...
     * @return the ActivityInner object itself.
     */
    public ActivityInner withExpiration(DateTime expiration) {
     ...
     * @return the ActivityInner object itself.
     */
    public ActivityInner withImportance(String importance) {
     ...
     * @return the ActivityInner object itself.
     */
    public ActivityInner withDeliveryMode(String deliveryMode) {
     ...
     * @return the ActivityInner object itself.
     */
    public ActivityInner withTextHighlights(List<TextHighlight> textHighlights) {
