...
public class MediaCard {
     ...
     */
    public MediaCard withTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return the MediaCard object itself.
     */
    public MediaCard withSubtitle(String subtitle) {
     ...
     * @return the MediaCard object itself.
     */
    public MediaCard withText(String text) {
        this.text = text;
        return this;
    }
     ...
     * @return the MediaCard object itself.
     */
    public MediaCard withImage(ThumbnailUrl image) {
        this.image = image;
        return this;
    }
     ...
     * @return the MediaCard object itself.
     */
    public MediaCard withMedia(List<MediaUrl> media) {
        this.media = media;
        return this;
    }
     ...
     * @return the MediaCard object itself.
     */
    public MediaCard withButtons(List<CardAction> buttons) {
     ...
     * @return the MediaCard object itself.
     */
    public MediaCard withShareable(Boolean shareable) {
     ...
     * @return the MediaCard object itself.
     */
    public MediaCard withAutoloop(Boolean autoloop) {
     ...
     * @return the MediaCard object itself.
     */
    public MediaCard withAutostart(Boolean autostart) {
     ...
     * @return the MediaCard object itself.
     */
    public MediaCard withAspect(String aspect) {
        this.aspect = aspect;
        return this;
    }
     ...
     * @return the MediaCard object itself.
     */
    public MediaCard withValue(Object value) {
        this.value = value;
        return this;
    }
